...
const CancelDeviceScheduleModal = ({
  hide,
  cancel,
  isPending,
}: {
  cancel: () => void;
  hide: Dispatch<SetStateAction<string | null>>;
  isPending: boolean;
}) => {
    ...
    <Modal>
      ...
      >
        <h2 className="text-center font-[600] text-base text-gray-800 pt-3">
          Cnaceling this device will remove all schedule related to this device
        </h2>
        ...
        <div className="flex-center gap-3">
          ...
          >
            {isPending ? (
              ...
              <span className="text-center ">Proceed</span>
            )}
          </Button>
...
export default CancelDeviceScheduleModal;
