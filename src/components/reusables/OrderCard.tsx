      ...
      <div className="flex flex-col font-inter">
        <div className="flex items-stretch gap-3  flex-col md:flex-row">
          <div className="flex items-stretch gap-2 ">
            <div className=" hidden md:px-4 bg-[#F3F5F7] h-[100px] md:grid place-items-center">
              <img
                src="/assets/graphics/user1.svg"
                alt=""
                className="w-4 h-4 md:h-[44px] md:w-[44px] rounded-full "
              />
            </div>
        ...
        <div className="hidden md:flex md:flex-center gap-[] py-3 font-dm-sans text-sm text-[#A5A5A5]">
