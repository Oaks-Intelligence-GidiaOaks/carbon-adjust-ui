...
const BuildingEmptyState: React.FC<BuildingEmptyStateProps> = ({ onAddBuilding }) => {
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-white">
      ...
      {/* Message */}
      <h2 className="text-2xl font-semibold text-[#495057] font-poppins mb-5">
        No building has been added
      </h2>
      <p className="text-[#6C6262] font-poppins mb-6">
      ...
      <button
        ...
        onClick={onAddBuilding}  // Call the parent function when clicked
      >
        Add building
