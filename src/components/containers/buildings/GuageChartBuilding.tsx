...
//   const AvgFootprint = Math.round(carbonFootprintTracker.average_footprint || 0);

//   console.log('h', carbonFootprintTracker )

//   const filledValue = Math.min(AvgFootprint, highFootprint);
