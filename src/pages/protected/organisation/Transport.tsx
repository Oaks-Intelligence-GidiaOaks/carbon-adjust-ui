...
import { IndividualTransport } from "@/components/containers/organisation/transport";
...
const Transport = () => {
  ...
  const activeComponent: IComponentMap = {
    ...
    [OrganizationTransportTabs.Staff]: <TransportHistory />,
    [OrganizationTransportTabs.Fleet]: <TransportHistory />,
  };
