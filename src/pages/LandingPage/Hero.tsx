...
const Hero = () => {
  return (
    <section className=" font-poppins relative h-[70vh] lg:h-[90vh] bg-cover bg-no-repeat bg-origin-content overflow-hidden flex flex-col ">
      {/* Background Video */}
      <video
      ...
      <div className="lg:container flex flex-col w-full h-[100%] justify-center lg:items-center items-center gap-10 lg:gap-[10rem]">
        ...
        >
          ...
          <h2 className="text-2xl text-[#eceeef] lg:text-[5.5rem] font-[400] leading-[3rem] text-center capitalize mb-2">
            carbon - adjust<sup>™</sup>
          </h2>
