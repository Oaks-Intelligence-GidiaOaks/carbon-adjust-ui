...
const Lifecycle = () => {
  ...
  return (
    <>
      <div className="flex bg-gradient-to-bl from-[rgba(173,216,230,0.5)] via-white to-[rgba(173,216,230,0.5)] p-4 flex-col justify-center items-center font-poppins">
        <motion.div
