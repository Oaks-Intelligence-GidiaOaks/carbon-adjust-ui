...
const MerchantRegister = () => {
  ...
  const {
    ...
    defaultValues: {
      accountType: { label: "MERCHANT", value: "MERCHANT" },
      merchantType: {
        label: "FINANCIAL_MERCHANT",
        value: "FINANCIAL_MERCHANT",
      },
    },
  });
  ...
  const registerUser = useMutation({
    ...
    onError: (error: any) => {
      toast.error(error.response.data.message || "Error registering merchant");
    },
    onSuccess: (data) => {
  ...
  const onSubmit: SubmitHandler<RegisterFormContext> = async (value) => {
    ...
    await registerUser.mutateAsync({
      ...
      merchantType: value.merchantType?.value as string,
      acceptTerms: true,
